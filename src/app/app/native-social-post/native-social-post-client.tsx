      ...
      <div className="space-y-6">
        ...
        {artifact && <section className="space-y-4 rounded-2xl border-2 border-violet-300 bg-violet-50/40 p-5 dark:border-violet-900 dark:bg-violet-950/20">
          ...
          <div className="flex flex-wrap justify-end gap-2">
            ...
            {artifactId && <Link href={`/app/content-review?sourceSocialPostId=${artifactId}`} className="min-h-11 rounded-lg border border-violet-300 bg-white px-4 py-2.5 text-sm font-bold text-violet-700 dark:border-violet-800 dark:bg-zinc-950 dark:text-violet-200">Semak lebih mendalam</Link>}
