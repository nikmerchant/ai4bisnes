type WhatsAppUser = { id: string; email?: string | null };

type Slice3AccessInput = {
...
export type Slice3AccessDecision = {
  allowed: boolean;
  reason:
    | "local_default"
    | "disabled"
...
export function resolveSlice3Access(input: Slice3AccessInput): Slice3AccessDecision {
