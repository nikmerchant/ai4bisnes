---
title: "7 Prompt AI untuk Ejen Hartanah Tulis Iklan Rumah Lebih Menarik"
description: "Koleksi 7 prompt ChatGPT terbukti untuk ejen hartanah Malaysia tulis iklan rumah, deskripsi properti, dan post media sosial yang lebih meyakinkan pembeli."
date: "2026-07-17"
tags: ["Hartanah", "Pemasaran Digital"]
heroImage: "/blog/7-prompt-ai-untuk-ejen-hartanah-tulis-iklan-rumah-lebih-menarik.png"
faq:
  - q: "Berapa banyak prompt yang perlu saya simpan untuk guna semula?"
    a: "Cukup 3-5 master prompt yang boleh diubah suai ikut jenis properti. Simpan dalam Notes atau template folder untuk akses pantas."
  - q: "Adakah ChatGPT cukup tepat untuk tulis spec rumah seperti keluasan dan harga?"
    a: "ChatGPT hanya tulis berdasarkan data yang anda beri. Pastikan semua angka (harga RM, keluasan persegi, bilik) disertakan dalam prompt untuk elak kesilapan fakta."
  - q: "Bolehkah AI tulis iklan dalam Bahasa Inggeris campur BM?"
    a: "Boleh. Nyatakan dalam prompt 'tulis dalam campuran BI-BM macam iklan properti Malaysia' dan hasilnya akan lebih natural."
  - q: "Perlukah saya edit iklan yang AI hasilkan sebelum post?"
    a: "Ya. Semak fakta, nada, dan pastikan ia bunyi macam suara agensi anda. AI bagi draf 80% siap, anda tambah 20% sentuhan akhir."
  - q: "Adakah prompt ini hanya untuk ChatGPT atau boleh guna AI lain?"
...
## 7 Prompt AI Khusus untuk Ejen Hartanah Malaysia
...
### 2. Prompt Caption Instagram/Reel untuk Property Showcase

Caption pendek yang trigger emosi dan ajak view listing:

> "Tulis 5 caption Instagram untuk post properti [ jenis/kawasan ]. Setiap caption bawah 100 aksara, mesti ada emoji maksimum 3, call-to-action 'DM untuk viewing', dan trigger point macam 'first home', 'invest', atau 'move-in ready'. Guna campuran BI-BM natural. Contoh trigger untuk caption 1: pembeli kali pertama."

### 3. Prompt Jawab Soalan Pembeli di WhatsApp

Ramai ejen habis masa jawab soalan berulang. Prompt ni hasilkan jawapan siap salin-tampal:

> "Saya ada properti [ jenis, kawasan ]. Bagi 10 jawapan pendek untuk soalan lazim pembeli: (1) Ada renovation apa? (2) Harga boleh nego? (3) Berapa maintenance? (4) Ada hidden cost? (5) Boleh viewing bila? (6) Berapa depo? (7) Status bumi/lot? (8) Umur building? (9) Tenant sedia ada? (10) Kenapa owner jual? Jawab dalam BM, ringkas, bawah 3 ayat setiap satu, nada profesional."

### 4. Prompt Post Facebook Group untuk Jaring Pembeli

Gunakan untuk group-group properti Malaysia yang aktif:

> "Tulis satu post Facebook untuk group properti Malaysia. Panjang 150-200 patah perkataan. Perkara: jual [ properti, kawasan, harga ]. Format: intro menarik → 3 bullet point kelebihan → call-to-action. Nada: santai tapi meyakinkan, macam ejen yang dah lama dalam industri. Tambah hashtag: #HartanahMalaysia #[Kawasan] #RumahUntukDijual."

### 5. Prompt Perbandingan Dua Properti untuk Klien
...
Prompt ni hasilkan draf testimonial yang boleh dikongsi dengan klien untuk approval:

> "Tulis 3 variasi testimonial pendek untuk ejen hartanah dari perspektif pembeli yang baru beli rumah pertama. Detail: [ kawasan, jenis rumah ]. Setiap testimonial bawah 50 patah. Nada: ikhlas, gembira, fokus pada pengalaman urusan yang lancar. Guna nama samaran macom 'Ahmad & Family' atau 'Cik Nur'."
...
Daripada taip prompt penuh setiap listing baru, simpan template master dalam Notes atau Google Keep dan hanya ubah 3-4 elemen setiap kali:

> "Template Master: Jual [Properti] di [Kawasan]. Harga RM[X]. Spesifikasi: [Y]. Kelebihan: [Z]. Nada: [PROFESIONAL/SANTAI]. Hasilkan: (1) Deskripsi listing (2) Caption IG (3) Jawapan soalan lazim."
...
**Q: Boleh AI bantu tulis iklan Inggeris untuk pasaran ekspatriat?**
A: Boleh. Tukar prompt ke Bahasa Inggeris dan nyatakan target audience. AI akan adjust tone dan pilihan kata.

**Q: Patut saya sertakan harga dalam iklan atau suruh PM?**
A: Kajian menunjukkan iklan dengan harga dapat 40% lebih interaksi. Namun ikut strategi agensi masing-masing.

**Q: Berapa panjang ideal caption Instagram untuk iklan rumah?**
A: 80-125 aksara untuk caption utama. Letak detail panjang di caption reply atau Stories.

**Q: Boleh AI hasilkan konten video Reel untuk properti?**
A: AI teks boleh hasilkan skrip dan caption. Untuk video, anda perlukan RakAI atau CapCut. Prompt boleh minta 'tulis skrip video 30 saat untuk Reel'.

**Q: Adakah iklan AI perlu disclose "content by AI"?**
...
**Q: Boleh AI bantu saya tulis emel follow-up selepas viewing?**
A: Boleh. Prompt: "Tulis emel follow-up untuk pembeli yang dah viewing [properti] 2 hari lepas. Nada: mesra, tak pushy. Tanya kalau ada soalan dan offer second viewing."

**Q: Berapa kerap perlu refresh prompt saya?**
