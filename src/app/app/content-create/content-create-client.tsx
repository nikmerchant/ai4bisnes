      ...
      <div className="space-y-6">
        ...
        {artifact && <section className="space-y-5 rounded-2xl border-2 border-violet-300 bg-violet-50/40 p-5 dark:border-violet-900 dark:bg-violet-950/20">
          ...
          <div className="flex flex-wrap justify-end gap-2">
            ...
            {artifactId && artifact.status === "approved" && artifact.platform === "tiktok" && <Link href={`/app/visual-plan?sourceContentCreateId=${artifactId}`} className="inline-flex min-h-11 items-center rounded-lg border border-violet-300 bg-violet-50 px-4 py-2.5 text-sm font-bold text-violet-700 dark:border-violet-800 dark:bg-violet-950 dark:text-violet-200">Bina Visual Plan →</Link>}
            {artifactId && artifact.status === "approved" && <Link href={`/app/performance?sourceContentCreateId=${artifactId}`} className="inline-flex min-h-11 items-center rounded-lg border border-violet-300 bg-violet-50 px-4 py-2.5 text-sm font-bold text-violet-700 dark:border-violet-800 dark:bg-violet-950 dark:text-violet-200">Rekod Prestasi →</Link>}
